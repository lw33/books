package lw.books.htw.c3.connector.http;

import lw.books.htw.c3.ServletProcessor;
import lw.books.htw.c3.StaticResourceProcessor;
...
public class HttpProcessor {
	...
	protected StringManager sm = StringManager
			.getManager("lw.books.htw.c3.connector.http");
