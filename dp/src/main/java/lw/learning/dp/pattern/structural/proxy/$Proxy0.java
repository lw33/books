...
public final class $Proxy0 extends Proxy implements IOrderService {
    ...
    public final int saveOrder(Order var1) throws UndeclaredThrowableException  {
        try {
    ...
    static {
        try {
            ...
            m3 = Class.forName("lw.learning.dp.pattern.structural.proxy.IOrderService").getMethod("saveOrder", Class.forName("lw.learning.dp.pattern.structural.proxy.Order"));
